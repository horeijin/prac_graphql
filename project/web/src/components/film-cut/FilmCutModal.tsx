...
export const FilmCutModal:FC<FilmCutModalProps> = ({ open, onClose, cutId }) => {
    ...
    >
      ...
      <ModalContent pt={2}>
        ...
        <ModalBody>
          ...
          {data && data.cut && (
            <FilmCutDetail cutImg={data.cut.src} cutId={data.cut.id} votesCount={data.cut.votesCount} isVoted={data.cut.isVoted} />
          )}
        </ModalBody>
      </ModalContent>
    </Modal>
